...
/**
 * <p>Uses jsoup to convert HTML input to lightly formatted plaintext.</p>
 * @author Jonathan Hedley, jonathan@hedley.net
 * @author Boomaa23, cmo93003@yahoo.com
 */
public class HTMLToPlainText {
    /**
     * <p>Formats an element to plaintext.</p>
    ...
    private static class FormattingVisitor implements NodeVisitor {
        ...
        public void tail(Node node, int depth) {
            if (StringUtil.in(node.nodeName(), "br", "dd", "dt", "p", "h1", "h2", "h3", "h4", "h5")) { append("\n"); }
        }
